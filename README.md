...
We contrast the Linux results with the ones computed for a extended dataset of 118 popular opens-source projects. More details about these projecs are provided in table below.
