...
//		System.out.println("INFO;noFirstAuthor;"+nFilesNoFirstAuthor+";"+nFiles+";"+((float)nFilesNoFirstAuthor/nFiles)*100);
		return repository;
	}
...
//				boolean hasHistory = setFileHistory(file, repository, fileInfo, mapFiles);
//				if (hasHistory)
//					tempfiles.add(file);
//				else{
//					fileInfo.setFiltered(true);
//					fileInfo.setFilterInfo("No-first author");
//				}
	...
	private static int nFilesNoFirstAuthor;
...
//		}
		...
		for (LogCommitFileInfo commitFile : logFilesObjectInfo) {
			...
			authorshipInfo.addCommit(commitInfo);
...
//					hasFirstAuthor = true;
				...
				// Ignoring renames, a kind of refactor
//				authorshipInfo.addNewDelivery();
				//file.addNewChange();		
			}
		...
		if (!file.hasFirstAuthor()){
//			System.out.println("INFO: No first author = "+file.getPath());
			nFilesNoFirstAuthor++;
			return false;
		}
		return true;
