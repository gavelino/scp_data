...
public class DistributionCalculator{
	private static final boolean IGNORE_NO_FIRST_AUTHOR = AuthorshipAnalyzer.IGNORE_NO_FIRST_AUTHOR;
	...
	public DistributionMetrics getDistibutionMetrics(Developer dev){
		...
		for (Entry<String, List<String>> entry : devModuleMap.entrySet()) {
			int nDevFiles = dev.getAuthorshipFiles(IGNORE_NO_FIRST_AUTHOR).size();
